  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative p-2 rounded-full text-gray-600 hover:text-gray-800 hover:opacity-90 focus:outline-none no-accent-hover"
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-1 -right-1 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-white bg-accent rounded-full">{unread}</span>
        )}
        {justReceived && (
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg z-50">
          <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200">
            ...
            <button onClick={markAllRead} className="text-sm text-gray-500 hover:underline">Mark all read</button>
          </div>

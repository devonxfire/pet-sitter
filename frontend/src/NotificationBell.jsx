  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative p-2 rounded-full text-white hover:opacity-90 focus:outline-none"
      ...
      >
        ...
        {justReceived && (
          <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-red-500 opacity-30 animate-ping pointer-events-none" />
        )}
      </button>

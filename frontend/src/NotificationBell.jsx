  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative p-2 rounded-full text-gray-600 cursor-pointer focus:outline-none no-accent-hover no-global-accent"
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg z-50">
            ...
            <button onClick={markAllRead} className="text-sm text-gray-500 hover:underline no-accent-hover no-global-accent cursor-pointer">Mark all as read</button>
          </div>
